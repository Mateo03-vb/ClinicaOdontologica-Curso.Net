...
public class HistorialMedicoesController : ControllerBase
{
    ...
    {
        return await _context.HistorialMedicoes.ToListAsync();
    }
    ...
    {
        var historialmedico = await _context.HistorialMedicoes.FindAsync(idhistorial);
    ...
    {
        _context.HistorialMedicoes.Add(historialmedico);
        await _context.SaveChangesAsync();
    ...
    public async Task<IActionResult> DeleteHistorialMedico(int? idhistorial)
    {
        ...
        _context.HistorialMedicoes.Remove(historialmedico);
        await _context.SaveChangesAsync();
    ...
    {
        return _context.HistorialMedicoes.Any(e => e.idHistorial == idhistorial);
    }
}
